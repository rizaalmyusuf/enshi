...
<head>
    ...
    <script src="https://kit.fontawesome.com/b74cd5d143.js" crossorigin="anonymous"></script>
    <!-- Google fonts-->
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="/">
                <img src="assets/img/logo-enshi.png" width="100" alt="ENSHI">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="https://drive.google.com/file/d/1iMROkkwnvpUYM522UhIpHttsSdwpTxkl/view?usp=share_link" target="_blank">Pedoman</a></li>
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/kamus">Kamus</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="">Kuis</a></li>
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="">Timbal Balik</a></li>
                </ul>
            </div>
        </div>
    </nav>